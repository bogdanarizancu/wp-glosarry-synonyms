...
class WPGS_Linkify extends WPG_Linkify{
	...
	public function setup_vars() {
		...
		add_filter('wpg_glossary_terms_query_args', [$this, 'querySynonyms']);
		$this->glossary_terms = wpg_glossary_terms ( 'linkify' );
		remove_filter('wpg_glossary_terms_query_args', [$this, 'querySynonyms']);
